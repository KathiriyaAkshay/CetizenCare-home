      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-black-400">We'll email you instructions on how to reset it.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto">
            <form>
              ...
              <div className="flex flex-wrap -mx-3 mt-6">
                <div className="w-full px-3">
                  <button className="btn text-white bg-teal-600 hover:bg-teal-700 w-full">Reset Password</button>
                </div>
              </div>
            </form>
            <div className="text-black-400 text-center mt-6">
              <Link href="/signin" className="text-teal-600 hover:text-black-200 transition duration-150 ease-in-out">Cancel</Link>
            </div>
          </div>
