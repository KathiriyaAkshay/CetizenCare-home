              ...
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
                  <div className="flex justify-between">
                    ...
                    <Link href="/reset-password" className="text-teal-600 hover:text-black-200 transition duration-150 ease-in-out">Forgot Password?</Link>
                  </div>
                </div>
              </div>
              <div className="flex flex-wrap -mx-3 mt-6">
                <div className="w-full px-3">
                  <button className="btn text-white bg-teal-600 hover:bg-teal-700 w-full">Sign in</button>
                </div>
              </div>
            </form>
            <div className="text-black-400 text-center mt-6">
              Don’t you have an account? <Link href="/signup" className="text-teal-600 hover:text-black-200 transition duration-150 ease-in-out">Sign up</Link>
            </div>
          </div>
