      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            {/* <p className="text-xl text-black-400">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p> */}
          </div>

          {/* Items */}
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 justify-around md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-lg text-black-400 text-center">
                "We uphold the highest standards of integrity, ensuring
                honest and reliable service for all."
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Excellence</h4>
              <p className="text-lg text-black-400 text-center">
                "Committed to excellence, we deliver top-notch service
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                ...
                <g transform="translate(21 21)" strokeLinecap="square" strokeWidth="2" fill="none" fillRule="evenodd">
                  ...
                  <path className="stroke-current text-teal-100" d="M11 0v22M0 11h22" />
                  <circle className="stroke-current text-teal-100" cx="11" cy="11" r="11" />
                </g>
              </svg>
              <h4 className="h4 mb-2">Transparency</h4>
              <p className="text-lg text-black-400 text-center">
                "Transparent practices guarantee fair pricing and clear
            ...
            <div className="relative flex flex-col items-center " data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Empowerment</h4>
              <p className="text-lg text-black-400 text-center">
                "Empowering customers and vendors alike, we provide
                the tools and opportunities for success."
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                ...
                <g transform="translate(21 22)" strokeLinecap="square" strokeWidth="2" fill="none" fillRule="evenodd">
                  <path className="stroke-current text-teal-300" d="M17 2V0M19.121 2.879l1.415-1.415M20 5h2M19.121 7.121l1.415 1.415M17 8v2M14.879 7.121l-1.415 1.415M14 5h-2M14.879 2.879l-1.415-1.415" />
              ...
              <h4 className="h4 mb-2">Customer-Centric</h4>
              <p className="text-lg text-black-400 text-center">
                "Our customer-centric approach ensures every decision
                we make is focused on delivering the best experience for you."
              </p>
            </div>
            ...
            <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h4 className="h4 mb-2">Community</h4>
              <p className="text-lg text-black-400 text-center">
                "Building a strong community, we connect customers
