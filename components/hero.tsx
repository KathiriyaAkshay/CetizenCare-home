      ...
      <div className="max-w-12xl mx-auto px-4 sm:px-6 relative">
          ...
          <svg className="max-w-full" width="564" height="552" viewBox="0 0 564 552" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="illustration-02" x1="-3.766" y1="300.204" x2="284.352" y2="577.921" gradientUnits="userSpaceOnUse">
                <stop stopColor="rgb(13 148 136)" stopOpacity=".01" />
                <stop offset="1" stopColor="rgb(13 148 136)" stopOpacity=".32" />
              </linearGradient>
            </defs>
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4" data-aos="fade-up">Connect. Create. Prosper.</h1>
            <p className=" h4 text-xl text-black-400 mb-8" data-aos="fade-up" data-aos-delay="200">One Stop Solution To Find Trusted Service Professionals !</p>

            <div className="text-xl text-black-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              <Typewriter
                options={{
                  strings: ['Home Cleaning', 'Pest Control', 'Salons', 'Movers & Packers', "We've got you covered with pretty much Everything!"],
                  autoStart: true,
                  loop: true,
                  delay: 75,
                  deleteSpeed: 20,
            ...
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up" data-aos-delay="400" className="aos-init aos-animate">
                <a className="btn text-white bg-teal-600 hover:bg-teal-700 w-full mb-4 sm:w-auto sm:mb-0 me-2" href="https://service.cetizencare.com">
                  Try Our Services
                </a>
                <a className="btn text-white bg-teal-600 hover:bg-teal-700 w-full mb-4 sm:w-auto sm:mb-0" href="https://vendor.cetizencare.com">
                  Join And Earn
                </a>
              </div>
          ...
          <div className="slider-container" style={{width:"100%"}}>
            <Slider {...settings}>
              ...
              <div>
              <Image src={Image2} alt="cover" style={{padding:"1rem"}}/>
              </div>  
              <div>
              <Image src={Image3} alt="cover" style={{padding:"1rem"}} />
              </div>
              <div>
              <Image src={Image4} alt="cover" style={{padding:"1rem"}} />
              </div>

              <div>
              <Image src={Image6} alt="cover" style={{padding:"1rem"}} />
              </div>
              <div>
              <Image src={Image7} alt="cover" style={{padding:"1rem"}} />
              </div>
